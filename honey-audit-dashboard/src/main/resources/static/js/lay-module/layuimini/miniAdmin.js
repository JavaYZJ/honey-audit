...
layui.define(["jquery", "miniMenu", "element", "miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabId').attr('lay-id', data.href + (new Date()).valueOf());
            $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src="' + data.href + (new Date()).valueOf() + ' "  ></iframe>');
        },
